...
<div class="max-w-4xl mx-auto">
	<!-- Page Header -->
	<div class="mb-6">
		<h1 class="text-3xl font-bold text-primary mb-2">Edit User Profile</h1>
	...
	<div class="flex flex-wrap gap-3 mb-6">
		...
		<a href="{{ route('users.index') }}" class="inline-flex items-center px-4 py-2 bg-card border border-border text-foreground rounded-lg hover:bg-accent transition-colors">
	...
	<div class="card-tw mb-6">
		<div class="p-6">
			<form action="{{ route('users.update', $user->id) }}" method="POST">
				...
				@include('users.form-tw', ['action' => 'update'])
			</form>
		</div>
	</div>
