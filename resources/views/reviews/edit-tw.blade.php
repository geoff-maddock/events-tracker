...
<div class="max-w-4xl mx-auto">
	...
	<div class="card-tw border-destructive/20">
		<div class="p-6">
			...
			<form action="{{ route('events.reviews.destroy', [$review->event->id, $review->id]) }}" method="POST" class="inline" data-confirm="Are you sure you want to delete this review? This action cannot be undone.">
				@csrf
				@method('DELETE')
