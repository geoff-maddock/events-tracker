...
<h1 class="display-crumbs text-primary">Categories @include('categories.crumbs')</h1>
		...
		<div id="filters-container" class="row">
			<div id="filters-content" class="col-xl-9">
				...
				{!! Form::open(['route' => [$filterRoute ?? 'categories.filter'], 'name' => 'filters', 'method' => 'POST']) !!}
				...
				<div id="filter-list" class="px-2 @if (!$hasFilter)d-none @endif">
					...
					<div class="row my-1">
						<div class="col-sm-2">
							...
							!!}
							{!! Form::close() !!}
							{!! Form::open(['route' => ['categories.reset'], 'method' => 'GET']) !!}
							{!! Form::hidden('redirect', $redirect ?? 'categories.index') !!}
							{!! Form::hidden('key', $key ?? 'internal_category_index') !!}
							{!! Form::submit('Reset',
								[
		...
		<div id="list-control" class="col-xl-3 visible-lg-block visible-md-block text-right my-2">
				<form action="{{ url()->current() }}" method="GET" class="form-inline">
					<div class="form-group row gx-1 justify-content-end">
						<div class="col-auto">
							<a href="{{ url()->action('CategoriesController@rppReset') }}" class="btn btn-primary">
						...
						<div class="col-auto">
							{!! Form::select('sort', $sortOptions, ($sort ?? 'categories.created_at'), ['class' => 'form-background form-select auto-submit']) !!}
						</div>
						<div class="col-auto">
