...
<div class="max-w-4xl mx-auto">
	...
	<div class="card-tw border-destructive/20">
		<div class="p-6">
			...
			<form action="{{ route('categories.destroy', $category->id) }}" method="POST" class="inline" data-confirm="Are you sure you want to delete this category? This action cannot be undone.">
				@csrf
				@method('DELETE')
