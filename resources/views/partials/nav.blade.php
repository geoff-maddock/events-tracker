			...
			<ul class="navbar-nav me-auto">
				<li class="nav-item dropdown {{ Request::is('events') ? 'active' : '' }}">
		          ...
		          <ul class="dropdown-menu" aria-labelledby="event-dropdown">
					...
					<li class="{{ Request::is('events/grid') ? 'active' : '' }}"><a href="{{ url('/events/grid') }}" class="dropdown-item">Event Image Index</a></li>
				...
				<li class="nav-item dropdown {{ Request::is('calendar') ? 'active' : '' }}">
		          ...
		          <ul class="dropdown-menu" aria-labelledby="calendar-dropdown">
					...
					<li class="{{ Request::is('tag-calendar') ? 'active' : '' }}"><a href="{!! url('/tag-calendar') !!}"  title="Show a list of keyword tags." class="dropdown-item">Keywords</a></li>
		          </ul>
		        </li>
				...
				<li class="nav-item dropdown d-xl-none {{ Request::is('forum') ? 'active' : '' }}">
					...
					<ul class="dropdown-menu" aria-labelledby="more-dropdown">
						...
						@endisset
						<li class="{{ Request::is('tags') ? 'active' : '' }}"><a href="{{ url('/tags') }}"  class="dropdown-item" title="Show a list of keyword tags.">Keywords</a></li>
