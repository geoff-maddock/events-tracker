		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
			<ul class="nav navbar-nav ">
				...
				<li class="dropdown visible-xs-block visible-sm-block visible-md-block">
							<a href="#" class="dropdown-toggle" data-hover="dropdown" role="button" aria-haspopup="true" aria-expanded="false" data-toggle="xtooltipx"  data-placement="bottom"  title="Show more options">More <span class="caret"></span></a>
					<ul class="dropdown-menu">
		        ...
		        <li>
				  <form class="navbar-form navbar-left" role="search" action="/search">
					<div class="form-group">
					  <input type="text" class="form-control" placeholder="Search" name="keyword" style="width: 150px;">
					</div>
				  </form>
		     	</li>
			</ul>
