...
<h1 class="display-6 text-primary">Permissions	@include('permissions.crumbs')</h1>
...
<div id="list-control" class="col-xl-3 visible-lg-block visible-md-block text-right">
		<form action="{{ url()->current() }}" method="GET" class="form-inline">
			<div class="form-group row gx-1 justify-content-end">
				...
				<div class="col-auto">
					{!! Form::select('sort', $sortOptions, ($sort ?? 'permissions.created_by'), ['class' => 'form-select form-background auto-submit'])	!!}
				</div>
				<div class="col-auto">
