		...
		<div class="lg:col-span-2">
			...
			<div class="card-tw border-destructive/20">
				<div class="p-6">
					...
					<form action="{{ route('blogs.destroy', $blog->slug) }}" method="POST" class="inline" data-confirm="Are you sure you want to delete this blog? This action cannot be undone.">
						@csrf
						@method('DELETE')
