...
<div class="row">
	...
	<div class="form-group col-md-2 {{$errors->has('menu_parent_id') ? 'has-error' : '' }}">
		...
		{!! Form::select('menu_parent_id', $menuOptions, (isset($menu->menu_parent_id) ? $menu->menu_parent_id : NULL), ['class' => 'form-control form-background']) !!}
...
<div class="row">
	<div class="form-group col-md-2 {{$errors->has('visibility_id') ? 'has-error' : '' }}">
		...
		{!! Form::select('visibility_id', $visibilityOptions, (isset($menu->visibility) ? $menu->visibility->id : NULL), ['class' => 'form-control form-background']) !!}
