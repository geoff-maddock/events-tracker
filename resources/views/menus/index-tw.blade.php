...
<div class="container mx-auto">
	...
	<div class="flex justify-between items-center mb-6">
		<h1 class="text-3xl font-bold text-primary">Menus</h1>
		<a href="{{ route('menus.create') }}" class="inline-flex items-center px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-colors">
	...
	<div class="card-tw mb-6">
		<div class="p-4">
			<form action="{{ url()->current() }}" method="GET" class="flex flex-wrap items-center gap-3">
				<a href="{{ url()->action([\App\Http\Controllers\MenusController::class, 'rppReset']) }}" class="p-2 bg-muted hover:bg-muted/80 rounded-lg transition-colors" title="Reset list controls">
	...
	<!-- Menus List -->
	@include('menus.list-tw', ['menus' => $menus])
