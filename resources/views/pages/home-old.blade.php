...
@section('content')
	...
	<div id="home-jumbotron" class="bg-light p-5 rounded-lg m-3 primary-gradient">
		...
		<div id="jumboContainer" class="collapsible collapse show">
			...
			<p>Arcane City is a calendar and guide to events, weekly and  monthly series, promoters, artists, producers, djs, venues and other entities that are part of the Pittsburgh scene.</p>
			<P>
