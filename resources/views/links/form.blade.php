<div class="row">
	...
	{!! Form::text('text', null, ['class' => 'form-control form-background']) !!}
...
<div class="row">
	...
	{!! Form::label('url','URL') !!}
	{!! Form::text('url', null, ['placeholder' => 'URL', 'class' =>'form-control form-background']) !!}
...
<div class="row">
	...
	{!! Form::text('title', null, ['placeholder' => 'Title text that will display when hovering over URL','class' => 'form-control form-background']) !!}
...
{!! Form::submit(isset($action) ? 'Update Link' : 'Add Link', ['class' =>'btn btn-primary my-2']) !!}
</div>
