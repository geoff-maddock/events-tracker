...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utilities_visibility__ = __webpack_require__(35);
...
__WEBPACK_IMPORTED_MODULE_0__utilities_visibility__["a" /* default */].init('body');
...
var Visibility = {
    init: function init(target) {
        $(target).find('[data-toggle="visibility"]').on('click', function (event) {
